    ...
    */
    ...
    return (
        <div className="contactPage relative flex flex-col items-center justify-center min-h-screen">
            <div className='contactTitle absolute text-3xl sm:text-6xl top-0 sm:pt-12 pt-8 pb-8 text-white'>
                Contact Me!
            </div>

            <div className='formContainer container flex flex-col items-center justify-center sm:pb-4 pt-24'>
                <form
                    className="grid w-full max-w-7xl sm:gap-16 gap-8 sm:m-0 sm:py-12 sm:pb-20 px-5 mx-auto"
                    onSubmit={sendEmail}
                    ref={form}
                    action='#'>
                    <div
                        className='grid sm:grid-cols-2 grid-cols-1 sm:gap-16 gap-8'>
                        <MyInformation/>

                        <input
                            type='text' id='name' className='form-dotted-item h-10 w-full p-4  placeholder-white'
                            required placeholder='Your Name' autoComplete='off' name="username" value={username}
                            onChange={(e) => setUsername(e.target.value)}>
                        </input>

                        <input
                            type='email' id='email' className='form-dotted-item h-10 w-full p-4  placeholder-white'
                            required placeholder='Your Email Adress' autoComplete='off' name="userEmail"
                            value={userEmail}
                    ...
                    <div className='flex justify-center'>
                        <input
                            ...
                            className='form-dotted-item h-10 sm:w-1/2 w-full p-4 rounded-md  bg-slate-900 text-white placeholder-white'
                    ...
                    <div className="flex justify-center">
                        <textarea id='message'
                                  className='form-dotted-item text-wrap resize-none sm:w-1/2 w-full p-4 h-40 rounded-md  bg-slate-900 text-white placeholder-white'
